...
import 'package:better_player_web_example/pages/auto_fullscreen_orientation_page.dart';
import 'package:better_player_web_example/pages/basic_player_page.dart';
import 'package:better_player_web_example/pages/cache_page.dart';
import 'package:better_player_web_example/pages/clearkey_page.dart';
import 'package:better_player_web_example/pages/controller_controls_page.dart';
import 'package:better_player_web_example/pages/controls_always_visible_page.dart';
import 'package:better_player_web_example/pages/controls_configuration_page.dart';
import 'package:better_player_web_example/pages/custom_controls/change_player_theme_page.dart';
import 'package:better_player_web_example/pages/dash_page.dart';
...
import 'package:better_player_web_example/pages/memory_player_page.dart';
import 'package:better_player_web_example/pages/normal_player_page.dart';
import 'package:better_player_web_example/pages/notification_player_page.dart';
import 'package:better_player_web_example/pages/overridden_aspect_ratio_page.dart';
import 'package:better_player_web_example/pages/overriden_duration_page.dart';
import 'package:better_player_web_example/pages/placeholder_until_play_page.dart';
import 'package:better_player_web_example/pages/playlist_page.dart';
import 'package:better_player_web_example/pages/resolutions_page.dart';
import 'package:better_player_web_example/pages/reusable_video_list/reusable_video_list_page.dart';
import 'package:better_player_web_example/pages/rotation_and_fit_page.dart';
import 'package:better_player_web_example/pages/subtitles_page.dart';
import 'package:better_player_web_example/pages/video_list/video_list_page.dart';
import 'package:better_player_web_example/pages/picture_in_picture_page.dart';
